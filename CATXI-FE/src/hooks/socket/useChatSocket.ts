...
import { chatTopic, readyTopic, publishTopic, systemMessageTopic } from './topics.ts';
...
export function useChatSocket(
  ...
  }, [roomId, jwtToken, onChatMessage, onReadyMessage]);
